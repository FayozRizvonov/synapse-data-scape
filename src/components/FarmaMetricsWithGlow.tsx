...
import { BauhausGlowCard } from './ui/bauhaus-glow-card';
...
const FarmaMetricsWithGlow = () => {
  ...
  const renderCard = (card: MetricCard, index: number) => {
    ...
    const cardContent = (
      <Card 
        className="bg-gradient-card backdrop-blur-xl border-0 flex flex-col transition-all duration-300 h-full"
      ...
      <div className="relative z-10 p-6 space-y-8 max-w-full">
        ...
        <div className="text-center space-y-4 pt-16">
          ...
          <p className="text-gray-600 dark:text-white/70 max-w-2xl mx-auto">
            Advanced pharmaceutical sales and marketing analytics dashboard with Bauhaus glow effects
          </p>
        </div>
...
export default FarmaMetricsWithGlow; 